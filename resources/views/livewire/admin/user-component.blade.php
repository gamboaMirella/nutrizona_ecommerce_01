<div>
    {{-- <x-admin-layout :breadcrumbs="[
        ...
        {{-- revisar componente de la barra de busqueda de welcome --}}
        ...
        <div class="px-6 py-4">
            ...
            <x-input wire:model="search" type="text" class="w-full" placeholder="Buscar por nombre">
            </x-input>
                  ...
                  <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                      ...
                      <tbody>
                          @foreach ($users as $user)
                              ...
                              <tr wire:key="{{ $user->email }}" class="bg-gray-100 border-b ">
                                  <th scope="row"
                                  ...
                                  <td>
                                    ...
                                    <label class="ml-2">
                                      <input {{$user->hasRole('costumer') ? 'checked' : ''}} 
                                  ...
                                  <td >
                                    <div class="flex justify-start">
                                        ...
                                        <button onclick="confirmDelete()" href=""
